...
export const Navbar = ({ filter, setFiltering }) => {
  ...
  return (
    <nav className="navbar orange navbar-expand-lg navbar-light bg-light fixed-top">
        <Link  className="navbar-brand crimson white-blur" to="/">   <i class="fas fa-shopping-cart"></i> Mes Courses en Ligne</Link>
      <button
      ...
      <div className="collapse navbar-collapse" id="navbarSupportedContent">
        <div className="ml-auto cart">
          ...
          <div className="menu-right">
             <Link to="/cart">
             <i class={`fas fa-shopping-bag fa-2x ${!items.length ? 'grey' : 'white-blur'}`}></i>
             </Link>
...
export const Card = props => {
  ...
  return (
    <div className="col-sm-4">
      ...
      <Modal item={item} updateCart={updateCart}/>
    </div>
  );
};
